...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AloneXMusic/assets/AloneXMusic.png")
        ...
        font = ImageFont.truetype("AloneXMusic/assets/font2.ttf", 40)
...
async def gen_qthumb(videoid, user_id):
    ...
    try:
        ...
        draw = ImageDraw.Draw(background)
        font = ImageFont.truetype("AloneXMusic/assets/font2.ttf", 37)
        ImageFont.truetype("AloneXMusic/assets/font2.ttf", 62)
        arial = ImageFont.truetype("AloneXMusic/assets/font2.ttf", 26)
        ImageFont.truetype("AloneXMusic/assets/font.ttf", 26)
